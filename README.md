...
Agent Plugins for AWS equip AI coding agents with the skills to help you architect, deploy, and operate on AWS. Agent plugins are currently supported by GitHub Copilot, Claude Code, and Cursor.
...
- GitHub Copilot (coding agent), Claude Code >=2.1.29, or [Cursor >= 2.5](https://cursor.com/changelog/2-5)
